...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleNoSuchElementFoundException(UserNotFoundException userFoundException, WebRequest request) {
//        log.error("Failed to find the requested element", itemNotFoundException);
        return buildErrorResponse(userFoundException, HttpStatus.NOT_FOUND, request);
    }
